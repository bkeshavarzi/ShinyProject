  ...
  dashboardBody(
    ...
    tabItems(
       tabItem(tabName = "section_data",
              ...
              fluidRow(column(12,DT::dataTableOutput("thickness_table_stat"))),
              fluidRow(column(12,DT::dataTableOutput("life_table_stat"))),
              fluidRow(column(12,DT::dataTableOutput("elevation_table_stat")))),
      ...
      tabItem(tabName = "temperature_data",
              ...
              fluidRow(column(12,DT::dataTableOutput("temperature_data_table"))),
      ...
      tabItem(tabName = 'traffic_data',
              ...
              fluidRow(column(12,DT::dataTableOutput("traffic_data_table")))),
      ...
      tabItem(tabName = 'performance_data',
              ...
              #fluidRow(column(12,DT::dataTableOutput("IRI_data_table")))
              
             ),
      
      tabItem(tabName = 'fatigue_data',
              
              fluidRow(column(6,box(selectInput('crack_state','Select State :',crack_state,selected=crack_state[1]))),
                       column(6,box(selectInput('crack_shrp','Select SHRP ID :',crack_shrp,selected=crack_shrp[1])))),
              
              fluidRow(column(12,box(plotOutput('crack_shrp_temp_plot')))),
              fluidRow(column(12,box(plotOutput('crack_ac_thermal_plot')))),
              fluidRow(column(12,box(plotOutput('crack_ac_traffic_plot')))),
              fluidRow(column(6,DT::dataTableOutput('crack_table1')),column(6,DT::dataTableOutput('crack_table2'))),
